...
const cleanTitles = [
  {
    ...
    title: '🕐 Enquanto calculamos o seu resultado... queremos te fazer algumas perguntas que vão tornar sua experiência ainda mais completa!'
  },
  {
...
async function setCleanTitles() {
  console.log('✨ Definindo títulos limpos e elegantes para as questões estratégicas...');
  ...
  try {
    ...
    console.log('🚀 Agora as questões estratégicas estão com layout limpo e profissional!');
