  ...
  return (
    <div className="container mx-auto min-h-screen p-6">
      ...
      <div className="mx-auto max-w-3xl rounded-lg border bg-card p-8 shadow-lg">
        ...
        <div className="mb-6">
          <span className="text-xl lg:text-2xl font-bold text-primary">Parabéns!</span>
          <div className="w-12 h-px mx-auto mt-2 bg-primary"></div>
        </div>
        <div className="text-center">
          <span className="text-2xl lg:text-4xl font-bold text-primary">Seu Estilo Ideal</span>
        </div>
        ...
        <div className="mt-2 flex flex-col gap-4">
          ...
          <div className="flex items-center justify-between">
            ...
            <span className="text-lg font-medium">5x R$ 8,83</span>
          </div>
          <div className="flex items-center justify-between">
        ...
        <div className="mt-8 text-center">
          <Button onClick={handleCTAClick} className="inline-flex items-center justify-center rounded-md bg-primary px-4 py-2 text-sm font-medium text-primary-foreground hover:bg-primary/90">
            <span className="flex items-center justify-center gap-2">Adquirir Agora</span>
          </Button>
        </div>
      </div>
    </div>
