...
export default function ResultPageWrapper({ id }: { id: string }) {
  const [loading, setLoading] = useState(true);
  const [result, setResult] = useState<any>(null);
  const [user, setUser] = useState<{ userName?: string } | null>(null);
  const [category, setCategory] = useState<string>('Resultado Personalizado');
  ...
  const tokens = {
    ...
    gradients: {
      primary: 'linear-gradient(to right, #0066ff, #3385ff)'
    }
  };
  ...
  const handleCTAClick = () => {
    // Aqui você pode redirecionar para a página de oferta ou checkout
  ...
  return (
    <div className="container mx-auto min-h-screen p-6">
      ...
      <div className="mx-auto max-w-3xl rounded-lg border bg-card p-8 shadow-lg">
        ...
        {user?.userName && (
          <div className="mb-6">
            <div data-lovable-id="result-greeting">
        ...
        <div className="text-center">
          <div data-lovable-id="result-category">
        ...
        <div className="mt-2 flex flex-col gap-4">
          ...
          <div className="flex items-center justify-between">
            ...
            <div data-lovable-id="offer-installments">
          ...
          <div className="flex items-center justify-between">
            ...
            <div data-lovable-id="offer-total-price">
        ...
        <div className="mt-8 text-center">
          ...
          >
            <div data-lovable-id="cta-button-text">
