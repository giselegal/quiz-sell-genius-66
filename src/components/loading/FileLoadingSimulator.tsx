        ...
        <div className="space-y-6">
          <div>
            <div className="flex justify-between mb-1">
              ...
              <span className="text-sm font-medium text-[#432818]">{Math.round(progressPercentage)}%</span>
            </div>
          ...
          <div className="bg-[#F9F6F3] rounded-md p-4 border border-[#B89B7A]/20">
            <div className="flex justify-between mb-2">
              ...
              <span className="text-sm font-medium text-[#432818]">{filesLoaded} de {totalFiles}</span>
            </div>
            
            <div className="flex items-center text-xs text-[#8F7A6A] animate-pulse">
              <div className="w-4 h-4 mr-2">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-full w-full text-[#B89B7A]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
