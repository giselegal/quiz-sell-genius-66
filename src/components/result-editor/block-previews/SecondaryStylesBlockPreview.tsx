...
const SecondaryStylesBlockPreview: React.FC<SecondaryStylesBlockPreviewProps> = ({ content }) => {
  // Mock secondary styles data for preview
    ...
    <div style={content.style}>
      ...
      >
        <motion.div className="flex items-center justify-between mb-2">
          <motion.h3 
            className="text-lg font-medium text-[#432818] relative inline-block"
            whileHover={{ x: 3 }}
          >
            <motion.span
              initial={{ width: 0 }}
            ...
            />
            {content.title || 'Estilos que Também Influenciam Você'}
          </motion.h3>
        </motion.div>
