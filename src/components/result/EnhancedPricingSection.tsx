          ...
          <div className="relative z-10">
                      ...
                      <div className="flex-1">
                        <div className="flex items-center gap-3 mb-1">
                          ...
                          <span 
                            ...
                            style={{ 
                              backgroundColor: product.badge === 'PRINCIPAL' 
            ...
            >
              {[
                ...
                { icon: <Zap className="w-4 h-4" />, text: 'Acesso Imediato', color: 'text-blue-500' },
                { icon: <Star className="w-4 h-4" />, text: 'Avaliação 5 estrelas', color: 'text-purple-500' }
              ].map((item, index) => (
                <motion.div
                  key={index}
