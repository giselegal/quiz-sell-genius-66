...
const componentLibrary: ComponentItem[] = [
  // Básicos
  {
    ...
    category: "básicos",
    description: "Adicione títulos e subtítulos",
  },
  {
    id: "text",
    name: "Texto",
    icon: <Type className="w-4 h-4" />,
    category: "básicos",
    description: "Parágrafos e blocos de texto",
  },
  {
    id: "image",
    name: "Imagem",
  ...
  },
  {
    ...
    category: "quiz",
    description: "Exibir resultado do quiz",
  },
  {
    id: "progress-bar",
  ...
  // Vendas
  {
    ...
    category: "vendas",
    description: "Card de produto/oferta",
    premium: true,
  },
  {
    id: "testimonial",
