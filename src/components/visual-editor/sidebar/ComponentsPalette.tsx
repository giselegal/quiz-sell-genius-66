      ...
      components: [
        {
          ...
          label: "Depoimento",
          icon: Quote,
          description: "Testemunho de cliente",
        },
        {
          type: "rating",
          label: "Avaliação",
          ...
          {componentCategories.map((category) => (
            <div key={category.title} className="space-y-3">
              ...
              <div className="flex items-center gap-3 mb-3">
                ...
                <Badge
                  variant="outline"
                  className="text-xs bg-slate-50/80 border-slate-200 shadow-sm"
                >
              ...
              <div className="grid grid-cols-1 gap-2">
                {category.components.map((component) => (
                  <div
                    key={component.type}
                    className={cn(
                      "group relative p-4 rounded-xl border-2 cursor-pointer transition-all duration-300 hover:shadow-lg backdrop-blur-sm active:scale-[0.98]",
