        ...
        elements: [
          {
            ...
            style: { fontSize: "1.5rem", fontWeight: "bold", textAlign: "center", color: "#dc2626" },
            position: { x: 0, y: 0 },
          },
          {
            id: "sq1-option-a",
            ...
            style: { backgroundColor: "#dc2626", color: "white", padding: "12px 24px", marginBottom: "12px" },
            position: { x: 0, y: 80 },
          },
          {
            id: "sq1-option-b",
          ...
          },
          {
            ...
            style: { backgroundColor: "#dc2626", color: "white", padding: "12px 24px" },
            position: { x: 0, y: 200 },
          },
        ],
        settings: {
        ...
        elements: [
          {
            ...
            style: { fontSize: "2rem", fontWeight: "bold", textAlign: "center", color: "#7c3aed" },
            position: { x: 0, y: 0 },
          },
          {
            id: "transition1-subtitle",
            type: "text",
            content: "Estamos criando seu perfil personalizado baseado em suas preferências",
            style: { fontSize: "1.2rem", textAlign: "center", color: "#6b7280" },
            position: { x: 0, y: 80 },
          },
          {
      ...
      },
      {
        ...
        elements: [
          ...
          },
          {
            ...
            type: "text",
            content: "Preparando seus resultados exclusivos e recomendações personalizadas...",
            style: { fontSize: "1.2rem", textAlign: "center", color: "#6b7280" },
            position: { x: 0, y: 80 },
          },
          {
            ...
            style: { fontSize: "1.3rem", textAlign: "center", color: "#10b981" },
            position: { x: 0, y: 160 },
          },
        ],
        settings: {
        ...
        elements: [
          {
            ...
            style: { fontSize: "2rem", fontWeight: "bold", textAlign: "center", color: "#1f2937" },
            position: { x: 0, y: 0 },
          },
          {
            id: "result-type",
            ...
            style: { fontSize: "1.8rem", fontWeight: "bold", textAlign: "center", color: "#3b82f6" },
            position: { x: 0, y: 80 },
          },
          {
            id: "result-description",
            type: "text",
            content: "Seu estilo combina sofisticação com praticidade. Você prefere peças atemporais que transmitem confiança e elegância.",
            style: { fontSize: "1.1rem", textAlign: "center", color: "#6b7280" },
            position: { x: 0, y: 140 },
          },
          {
            id: "result-image",
            type: "image",
            content: "https://via.placeholder.com/400x300?text=Elegante+Clássico",
          ...
          },
          {
            ...
            style: { backgroundColor: "#10b981", color: "white", padding: "16px 32px", borderRadius: "8px", fontSize: "1.1rem" },
            position: { x: 0, y: 320 },
          },
        ],
        settings: {
        ...
        elements: [
          {
            ...
            style: { fontSize: "2.2rem", fontWeight: "bold", textAlign: "center", color: "#1f2937" },
            position: { x: 0, y: 0 },
          },
          {
            id: "offer-subtitle",
            type: "text",
            content: "Baseado no seu perfil único, criamos um guia completo com:",
            style: { fontSize: "1.3rem", textAlign: "center", color: "#6b7280" },
            position: { x: 0, y: 80 },
          },
          {
            id: "offer-benefits",
            type: "text",
            content: "✓ Análise completa do seu biotipo\n✓ Guia de cores personalizadas\n✓ Looks prontos para cada ocasião\n✓ Lista de compras inteligente",
            style: { fontSize: "1.1rem", textAlign: "left", color: "#374151", lineHeight: "1.8" },
            position: { x: 0, y: 140 },
          },
          {
            id: "offer-price-old",
            type: "text",
            content: "De R$ 497",
            style: { fontSize: "1.5rem", textAlign: "center", color: "#6b7280", textDecoration: "line-through" },
            position: { x: 0, y: 260 },
          },
          {
            id: "offer-price-new",
            ...
            style: { fontSize: "2rem", fontWeight: "bold", textAlign: "center", color: "#dc2626" },
            position: { x: 0, y: 300 },
          },
          {
            id: "offer-urgency",
            ...
            style: { fontSize: "1.2rem", textAlign: "center", color: "#dc2626", fontWeight: "bold" },
            position: { x: 0, y: 360 },
          },
          {
            id: "offer-form-name",
            ...
            style: { width: "100%", padding: "16px", marginBottom: "16px", borderRadius: "8px", border: "2px solid #e5e7eb" },
            position: { x: 0, y: 420 },
          },
          {
            id: "offer-form-email",
          ...
          },
          {
            ...
            style: { backgroundColor: "#dc2626", color: "white", padding: "20px 40px", borderRadius: "8px", fontSize: "1.3rem", fontWeight: "bold", width: "100%" },
            position: { x: 0, y: 540 },
          },
          {
            id: "offer-guarantee",
