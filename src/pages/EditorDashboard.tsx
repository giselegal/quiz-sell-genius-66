...
export const EditorDashboard: React.FC = () => {
  ...
  const loadPages = async () => {
    try {
      setLoading(true);
      const pagesList = JSON.parse(localStorage.getItem('quiz-editor-pages') || '[]');
      setPages(pagesList);
    } catch (error) {
  ...
  const handleDuplicatePage = async (pageId: string) => {
    try {
      ...
      localStorage.setItem(`quiz-editor-page-${newId}`, JSON.stringify(duplicatedData));
      ...
      localStorage.setItem('quiz-editor-pages', JSON.stringify([...pages, newPageSummary]));
  ...
  const handleImportPage = (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    reader.onload = (e) => {
      try {
        ...
        localStorage.setItem(`quiz-editor-page-${newId}`, JSON.stringify(pageData));
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-xl font-semibold text-gray-900">Quiz Editor</h1>
                ...
                <DialogContent>
                  ...
                  <div className="space-y-4">
                    <p className="text-gray-600">
                      Selecione um arquivo JSON exportado anteriormente para importar uma página.
                    </p>
                    <Input
                      type="file"
                      accept=".json"
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
            <Card>
              <CardHeader className="pb-2">
                <CardTitle className="text-sm font-medium text-gray-600">Total de Páginas</CardTitle>
              </CardHeader>
              <CardContent>
                  ...
                  <div className="flex items-start justify-between">
                    ...
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end">
                        ...
                        <DropdownMenuItem onClick={() => handlePreviewPage(page.id)}>
