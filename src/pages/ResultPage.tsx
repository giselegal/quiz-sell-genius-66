...
const trackHotmartConversion = (eventType: string, additionalData: Record<string, unknown> = {}) => {
...
const ResultPage: React.FC = () => {
  ...
  const handleSecondaryPurchase = useCallback((category: string) => {
  ...
  return (
    <div className={`min-h-screen ${globalStyles}`} style={{ background: tokens.colors.background }}>
      ...
      <AnimatedWrapper>
        <div className="container mx-auto px-4 lg:px-6 py-8 lg:py-12">
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex justify-center space-x-4">
                    {[Crown, Gem, Sparkles].map((Icon, index) => (
                      <div key={index} className="w-12 h-12 bg-gradient-to-br from-[#B89B7A] to-[#aa6b5d] rounded-full flex items-center justify-center shadow-lg">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid gap-3">
                      <p className="text-[#8F7A6A] italic">
                        Características detalhadas serão personalizadas no curso completo.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="pt-6">
                    <Button
                      ...
                      className={`
                        ...
                        ${isButtonHovered ? 'scale-105 -translate-y-1' : 'scale-100'}
            ...
            <section id="secondary-styles" className="mb-16 lg:mb-24">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
                {secondaryStylesData.map((style, index) => (
                  <Card key={style.category} className="group overflow-hidden border-0 shadow-lg hover:shadow-xl transition-all duration-300 bg-white">
                    <div className="aspect-[4/5] relative overflow-hidden">
                      ...
                      <div className={`absolute top-4 right-4 bg-gradient-to-r ${
                        index === 0 ? 'from-[#B89B7A] to-[#aa6b5d]' : 'from-[#aa6b5d] to-[#8F5A4D]'
                    ...
                    <div className="p-6 space-y-4">
                      ...
                      <Button
                        onClick={() => handleSecondaryPurchase(style.category as string)}
                        variant="outline"
            ...
            <div className="bg-gradient-to-br from-[#fffaf7] to-[#f9f4ef] rounded-3xl p-8 lg:p-12 shadow-2xl border border-[#B89B7A]/10">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
                {Object.entries(styleConfig).map(([category, config]) => (
                  <Card key={category} className="group overflow-hidden border-0 shadow-lg hover:shadow-xl transition-all duration-300 bg-white">
                    <div className="aspect-square relative overflow-hidden">
                      ...
                      <div className="absolute bottom-0 left-0 right-0 p-4 text-white">
                        <h4 className="font-serif text-lg font-semibold mb-1">{category}</h4>
                        <p className="text-sm text-white/90 line-clamp-2">{config.description}</p>
                      </div>
                    </div>
                  </Card>
                ))}
              ...
              <div className="text-center mb-12">
                <div className="max-w-4xl mx-auto">
                  ...
                  <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {[
                      { icon: Target, title: "Análise Personalizada", desc: "Avaliação completa do seu estilo único" },
                      { icon: Palette, title: "Guia de Cores", desc: "Paleta personalizada para seu tom de pele" },
                      { icon: Scissors, title: "Cortes Ideais", desc: "Sugestões de cortes para seu rosto" },
                      { icon: Sparkles, title: "Styling Tips", desc: "Técnicas exclusivas de styling" },
                      { icon: Crown, title: "Consultoria VIP", desc: "Acesso a sessões de mentoria" },
                      { icon: Gift, title: "Bônus Exclusivos", desc: "Materiais extras e atualizações" }
                    ].map((item, index) => (
                      <div key={index} className="bg-white rounded-xl p-6 shadow-lg border border-[#B89B7A]/10">
                        ...
                        <h4 className="font-semibold text-[#2C1810] mb-2">{item.title}</h4>
              ...
              <div className="max-w-lg mx-auto bg-white rounded-2xl p-8 shadow-xl border-2 border-[#B89B7A]/20">
                <div className="text-center mb-6">
                  <div className="text-[#8F7A6A] text-lg line-through mb-2">De R$ 497</div>
                  <div className="text-4xl font-bold text-[#2C1810] mb-2">
                    R$ 197
                    <span className="text-lg font-normal text-[#5D4A3A]">/único</span>
                  </div>
                  <div className="text-[#4CAF50] font-semibold">60% de desconto</div>
                </div>
                ...
                <div className="mt-6 space-y-3">
                  {[
                    ...
                    <div key={index} className="flex items-center space-x-3 text-[#5D4A3A]">
          ...
          <Suspense fallback={<div className="flex justify-center p-8"><div className="animate-spin rounded-full h-8 w-8 border-b-2 border-[#B89B7A]"></div></div>}>
