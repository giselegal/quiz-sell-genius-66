...
import { ShoppingCart, CheckCircle, ArrowDown, Clock, ChevronLeft, ChevronRight, Shield, Award, Hourglass, Star, Gift, Target, Zap, TrendingUp, Plus } from 'lucide-react';
...
const ResultPage: React.FC = () => {
  ...
  const handleAddNewBlock = () => {
    addBlock('text'); // Por padrão adiciona um bloco de texto
  };
