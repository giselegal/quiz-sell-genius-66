...
const ResultPage: React.FC = () => {
  ...
  // Extrair primaryStyle e secondaryStyles do resultado do quiz
  ...
  if (isLoading('images')) return <ResultSkeleton />;
  ...
  const {
    ...
    guideImage,
    description
  } = styleInfo || styleConfig.Natural; // fallback to Natural if category not found
