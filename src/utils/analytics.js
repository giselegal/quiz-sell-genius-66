...
/**
 * Rastreia cliques em ofertas/botões de conversão
 * @param {object} eventData - Dados sobre o clique na oferta
 */
export const trackOfferClick = (eventData = {}) => {
  if (typeof window === "undefined") return;
  ...
  console.log("[Analytics] Clique em oferta rastreado:", eventData);
};
